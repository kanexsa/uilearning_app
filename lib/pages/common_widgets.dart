...
AppBar buildAppBar(String appBarTitleText) {
  return AppBar(
    //appbarın altındaki ince gri düz çizgi.
...
//context parametresi bloc erişimi için lazım.
Widget buildThirdPartyLogin(BuildContext context) {
  return Container(
    ...
    child: Row(
      ...
      children: [_reusableIcons("google"), _reusableIcons("apple"), _reusableIcons("facebook")],
    ),
  );
}
...
Widget reusableText(String text) {
  return Container(
    ...
    child: Text(
      text,
      style: TextStyle(color: Colors.grey.withOpacity(0.8), fontWeight: FontWeight.normal, fontSize: 14.sp),
    ),
  );
}
